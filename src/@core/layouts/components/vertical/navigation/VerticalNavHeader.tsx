  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft(), ...conditionalColors() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          <img
            src={mode === 'dark' ? '/images/auth/sar-logo-char-only-dark.svg' : '/images/auth/sar-logo-char-only.svg'}
            width={navCollapsed && !navHover ? 32 : 64}
            height={navCollapsed && !navHover ? 32 : 64}
            alt='SAR Logo'
          />
